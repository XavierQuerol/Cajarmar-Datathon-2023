...
PATH = "trained_models/"
model = Net()
model.load_state_dict(torch.load(PATH + "model_cas3_46.pth", map_location=torch.device('cpu')))

file = open("./trained_models/gradientboosting_cas3.obj", "rb")
model_gradient = pickle.load(file)

file = open("./trained_models/ordinal_encoder_cas3.obj", "rb")
ordinal_encoder = pickle.load(file)

file = open("./trained_models/one_hot_encoder_cas3.obj", "rb")
one_hot_encoder = pickle.load(file)

file = open("./trained_models/scaler_cas3.obj", "rb")
...
df_22 = pd.read_csv("../../DATASETS_FINALS/df_22_cas3.csv")
df_22 = df_22.astype({"CAMPAÑA": str, "ID_ESTACION": str, "VARIEDAD": str, "MODO": str, "TIPO": str, "COLOR": str})
...
new_22.to_csv("../../PREDICTIONS/cas3_cnn.csv", index = False)
