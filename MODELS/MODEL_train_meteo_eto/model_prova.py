# -*- coding: utf-8 -*-
"""
Created on Wed Mar  8 00:09:04 2023
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.convs_4_c = 3
        self.convs_5 = nn.ModuleList([nn.Conv1d(3,3,5, padding=2) for i in range(100)])
        self.convs_5_c = 3
        self.convs_6 = nn.ModuleList([nn.Conv1d(3,3,5, padding=2) for i in range(100)])
        self.convs_6_c = 3
        self.convs_7 = nn.ModuleList([nn.Conv1d(3,3,5, padding=2) for i in range(100)])
        self.convs_7_c = 3
        self.convs_8 = nn.ModuleList([nn.Conv1d(3,3,5, padding=2) for i in range(100)])
        self.convs_8_c = 3

        self.maxpool = nn.MaxPool2d((10,1), stride=(3,1))
                
        self.linear_1 = nn.ModuleList([nn.Linear(399, 100) for i in range(3)])
        self.features_1 = 100
        self.linear_2 = nn.ModuleList([nn.Linear(100, 10) for i in range(3)])
        self.features_2 = 10
