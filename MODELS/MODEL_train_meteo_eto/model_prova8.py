# -*- coding: utf-8 -*-
"""
Created on Wed Mar  8 10:04:35 2023
...
class Net(nn.Module):
    ...
    def convolute(self, x, convs, channels):
        ...
        out = torch.zeros([x.shape[0],channels,x.shape[2],x.shape[3]], device=self.device)
    ...
    def mlp(self, x, linears, features):
        ...
        out = torch.zeros([x.shape[0]*x.shape[2], x.shape[1], features], device=self.device)
